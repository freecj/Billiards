...
float gParticleSize = 0.1; //size of particles to generate
float gAmountToRotate = 9; //amount to rotate each particle each frame
float gSpeed = 0.009; //speed multiplier
float gFriction = 0.1; //particles lose 10% speed upon hitting the ground
